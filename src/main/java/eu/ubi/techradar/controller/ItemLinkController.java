...
public class ItemLinkController {
    ...
    ItemLinkController(ItemRepository repository, ItemResourceAssembler assembler) {
        this.repository = repository;
        this.assembler = assembler;
    }


    @PostMapping("/itemslink")
    ...
    @RequestMapping(value = "/itemslink", method = RequestMethod.GET,
    ...
    public Resources<Resource<Item>> getAll() {
        ...
        return new Resources<>(items,
                linkTo(methodOn(ItemLinkController.class).getAll()).withSelfRel());
    }


    @RequestMapping(value = "/itemslink/{id}", method = RequestMethod.GET,
            produces = {MediaType.APPLICATION_JSON_VALUE, "application/hal+json"})
    ...
    @RequestMapping(value = "/itemslink/{id}", method = RequestMethod.PUT)
